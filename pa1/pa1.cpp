...
int main(int argc, char** argv)
{
    ...
    double sample_space =0 ; // = 1/(n_sample_pts-1)
    double t0 = 0;           //t0 =t
    double t1 = 0;           // t1 = 1-t
    double upper_x = 0;
    double upper_y = 0;
    double upper_right_x = 0;
    double upper_right_y =0 ;

    double* dyn_table = NULL;
    double* out_pts = NULL;
    ...
    sample_space = (double)(1.0)/ (double)(n_sample_pts-1);
    out_pts = new double[n_sample_pts*2];
